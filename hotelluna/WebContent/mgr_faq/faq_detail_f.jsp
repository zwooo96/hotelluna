	...
	<div id="container" style="width:1800px; height:750px; margin:0px auto; margin-top: 10px; ">
		...
		<table class="table table-borderless" style="width:1000px; margin:0px auto; font-size: 17px">
		    ...
		    <tr>
		      ...
		      <td>
		      <form id="replyFrm" name="replyFrm" action="faq_insert.jsp?current_page=<%= currentPage %>&req_num=<%= reqNum %>" method="post">
			      <textarea id="reply" name="reply" style="overflow-y: scroll; height:200px; width:600px"></textarea>
		      </form>
		      </td>
		    </tr>
			<%
		...
		<div style="margin:0px auto; width: 160px; margin-top:30px; margin-bottom:50px">
			...
			<input type="button" value="등록" id="insert" name="insert" class="btn btn-dark" style="cursor: pointer;"/>
		</div>
